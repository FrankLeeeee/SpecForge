...
mkdir -p $ROOT_DIR/outputs/qwen3-30b-a3b-instruct-eagle3-sharegpt-hf-backend
...
torchrun \
    ...
    --output-dir $ROOT_DIR/outputs/qwen3-30b-a3b-instruct-eagle3-sharegpt-hf-backend \
    --num-epochs 10 \
    --batch-size 1 \
    --learning-rate 1e-4 \
    --max-length 4096 \
